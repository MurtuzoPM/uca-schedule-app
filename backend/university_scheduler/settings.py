...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-slb!&#@3t+)^4vpvpgag=q5(sh)%hv02^^q9#^e3wfn8g2)v%w')
...
# Database
# Use DATABASE_URL if available (Railway), otherwise use MySQL config
